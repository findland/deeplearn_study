...
skcode = 600391
skcode = str(skcode)
df1 = ts.get_k_data(skcode,ktype="D",start='2018-08-20',end='2020-08-20')
...
train_set_scaler = data_scaler[:len(data_scaler)-300]
test_set_scaler = data_scaler[len(data_scaler)-300:]
...
for i in range(len(train_set_scaler)-60):
...
for i in range(len(test_set_scaler)-60):
...
checkpoint_save_path = "./Rnn/STOCK_1/stock.ckpt"
